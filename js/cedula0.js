...
var doc = new jsPDF({
    ...
    doc.setFontType('normal');
    doc.text(54.766,131.712,'( Si lo posee )                                                                         ( Con Homoclave )');
    doc.text(22.125,139.035, 'NOMBRE ______________________________________________________________________________________');
    //doc.line(36.647,138.941,188.878,138.941);
    doc.text(39.412,142.714,'  A. PATERNO                              A. MATERNO                        NOMBRE(S)');
    doc.text(22.128,149.957,'DOMICILIO PERSONAL:');
    doc.text(22.042,154.640, 'CALLE: _____________________________________________  No. EXTERIOR: __________ No. INT ___________');
    //doc.line(34.552,154.340,113.878,154.340);
    //doc.line(139.798,154.340,155.878,154.340);
    //doc.line(169.552,154.340,188.878,154.340);
    doc.text(22.042,159.701, 'COLONIA: ___________________________________________ COD. POSTAL: _____________________________');
    //doc.line(38.751,160.095,113.878,160.095);
    doc.text(22.042,165.797, 'CIUDAD: ____________________________________________  DELEG/MUNI: ______________________________');
    doc.text(22.042,171.521, 'ENTIDAD FED: _______________________________________  TELÉFONO: _______________________________');
    doc.text(22.042,177.819, 'NACIONALIDAD: ______________________________________ LUGAR NAC. ______________________________');
    doc.text(22.042,181.994, 'ACTA DE NACIMIENTO:');
    doc.text(22.042,185.169, '(Solo por primera vez)   No. ACTA: ________________________ FECHA DE NACIMIENTO ____________________');
    ...
    doc.text(22.033,60.169,'CLAVE                                          NOMBRE:     _________________________________________________________');
    ...
    doc.text(22.115,91.091,'FECHA EXAMEN MÉDICO:___________________________   FECHA DE VENCIMIENTO _________________________');
    doc.text(22.115,97.452,'RESULTADO EXAMEN MÉDICO:               APTO:                                                 NO APTO:');
    ...
    doc.text(22.033,117.146,'CLASE DE EXAMEN:         1                      2                      3                 GRUPO SANGUINEO_________________________');
    ...
    doc.text(22.144,166.824,'CURSO:                     UNIDAD:                                       ESPEDICIÓN');
    ...
    doc.text(22.125,203.427,'No. DOCUMENTO:                                      FECHA EXPEDICIÓN:                                           FECHA VENC.:');
    ...
    doc.setFontType('bold');
    doc.text(26.78,50.972,'DATOS CURSOS DE FORMACIÓN, CAPACITACIÓN Y/O ADIESTRAMIENTO EN EL ÚLTIMO AÑO DE VIGENCIA:');
    doc.line(19.936,54.763,197.687,54.763);
    doc.setFontType('normal');
    doc.text(22.042,58.084,'CENTRO FORMACIÓN, CAPACITACIÓN Y/O                   CURSO:                 CLAVE                              FECHA');
    doc.text(22.042,61.724,'ADIESTRAMIENTO:                                                            (PROGRAMA)        GRUPO:');
    ...
    doc.text(22.033,113.861,'CLASE DE LICENCIA:_______________________________         NUMERO: ____________________________');
    doc.line(19.936,118.392,198.237,118.392);
    doc.setFontType('normal');
    doc.text(22.144,125.034,'FECHA REVALIDACION ACTUAL:                                                FECHA VENCIMIENTO:');
    ...
    doc.text(22.144,136.049,'FECHA EXPEDICIÓN (INICIAL)____________________      LUGAR EXPEDICION (INICIAL):_____________________');
    doc.text(22.077,144.162,'(11) DATOS FORMATO OACI (Si lo posee):');
    doc.rect(19.936,140.813,178.301,21.359);
    doc.text(22.125,151.143,'No. OACI:  _______________________________               FECHA EXPEDICIÓN:   _____________________________');
    ...
    doc.setFontType('normal');
    doc.text(61.782,51.861,'*AUTORIZADA       PERIODO DE ADIESTRAMIENTO                                ACREDITADAS');
    doc.text(21.956,55.801,'TIPO DE CAPACIDAD                 POR:                   FECHA DE INICIO              FECHA TERMINO');
    doc.setFontType('bold');
    ...
    doc.setFontType('normal');
    doc.text(54.766,118.123,'( Si lo posee )                                                                         ( Con Homoclave )');
    doc.text(22.125,125.446, 'NOMBRE ______________________________________________________________________________________');
    doc.text(39.412,129.857,'     A. PATERNO                              A. MATERNO                           NOMBRE(S)');
    doc.text(22.128,136.368,'DOMICILIO:');
    doc.text(22.042,141.051, 'CALLE: _____________________________________________  No. EXTERIOR: __________ No. INT ___________');
    doc.text(22.042,147.112, 'COLONIA: ___________________________________________ COD. POSTAL: _____________________________');
    doc.text(22.042,152.208, 'CIUDAD: ____________________________________________  DELEG/MUNI: ______________________________');
    doc.text(22.042,157.932, 'ENTIDAD FED: _______________________________________  TELÉFONO: _______________________________');
    doc.rect(19.936,166.363,177.751,77.00);
    doc.text(22.077,172.779,'(15)');
    doc.setFontType('bold');
    doc.text(28.454,172.779,'ANEXOS:');
    doc.setFontType('normal');
    doc.text(43.928,172.779,'(Esta documentación deberá ser resguardada en Comandancia en caso de tramites foráneos)');
    doc.setFontSize(8);
    ...
    doc.text(42.056,209.817,'DOCUMENTOS DE CONVALIDACION S.D.N. (Para obtención de licencia solo en la Dirección de Licencias)');
    doc.text(42.056,216.346,'COPIA RECIBO DE PAGO: No. RECIBO:                                                       FECHA DE PAGO');
    ...
    doc.text(30.252,120.197,'BAJO PROTESTA DE DECIR VERDAD, DECLARO QUE LA INFORMACIÓN ASENTADA POR PARTE DE ESTA');
    doc.setFontSize(8.92);
    doc.text(30.252,123.852,'AUTORIDAD  AERONÁUTICA  EN  CADA  UNO  DE  LOS  FORMATOS  Y  DOCUMENTOS  QUE  INTEGRAN  EL');
    doc.setFontSize(9.19);
    doc.text(30.170,127.979,'EXPEDIENTE DE SOLICITUD RESPECTIVO, SON FIDEDIGNOS; APERCIBIDO DE LA RESPONSABILIDAD Y');
    doc.setFontSize(9.23);
    doc.text(30.252,132.213,'SANCIONES A LAS QUE ME HAGO ACREEDOR, ESTABLECIDAS EN LA LEY PENAL, EN LA LEY FEDERAL');
    doc.text(30.252,136.567,'DE RESPONSABILIDADES DE LOS SERVIDORES PÚBLICOS, Y EN LAS DEMÁS LEYES Y REGLAMENTOS');
